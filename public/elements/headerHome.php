<nav class="navbar navbar-expand-lg bg-dark bg-gradient">
  ...
  <a class="btn btn-outline-primary text mx-3" href="../SignIn.php" role="button">Вход</a>
  <a class="btn btn-outline-primary text mx-3" href="../registration.php" role="button">Регистрация</a>
</nav>